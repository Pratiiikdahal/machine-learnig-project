...
st.markdown("Toy model to play to classify iris flowes into\(setosa,versicolor,vrigininca) based on their sepal/petal \ and length/width")
...
st.text('')
st.text('')
st.markdown('Created by:Pratik Dahal @2024' \
